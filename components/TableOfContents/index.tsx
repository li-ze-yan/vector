...
import { NavList, NavListHeading, NavListItem, NavListItems, NavListLink } from "../NavList";
import { TOCEntry } from "./type";
...
export function TableOfContents({ tableOfContents }: { tableOfContents: TOCEntry[] }) {
  ...
  useEffect(() => {
    ...
    const callback = (entries: IntersectionObserverEntry[]) => {
      ...
      const firstVisibleSection = Array.from(sections.entries()).find(([element]) =>
