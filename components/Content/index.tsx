...
function htmlSnippet({
  ...
  const parts = [`<!-- [!code classes:${featuredClass}] -->\n`];
  ...
  return (
    <>
      <p>
        ...
        with a breakpoint variant like <code>{breakpoint}:</code> to only apply the utility at{" "}
        {screens[breakpoint]} screen sizes and above:
      </p>
      {children || (
        <div>
          <div className="not-prose">
      ...
      <p>
        ...
        <Link href="/docs/hover-focus-and-other-states">variants documentation</Link>.
      </p>
    </>
  );
}
...
export function TargetingSpecificStates({
  ...
  return (
    <>
      <p>
        Prefix {startsWithVowel(property) ? "an" : "a"} <code>{property}</code> utility with a
        variant like <code>{variant}:*</code> to only apply the utility in that state:
      </p>
      {children || (
        <div>
          <div className="not-prose">
...
export function CustomizingYourTheme({
  ...
  return (
    <>
      <p>
        Use the <code>--{themeKey || utility || utilities![0]}-*</code> theme variables to customize
        the {name} utilities in your project:
      </p>
      <div>
        <div className="not-prose">
          <CodeExample
      ...
      {includeSpacingNote && (
        <>
          <p>
            ...
            utilities are driven by the <code>--spacing</code> theme variable, which you can also
            customize:
          </p>
          <div>
            <div className="not-prose">
      ...
      {includeSpacingNote ? (
        <p>
          ...
          <Link href="/docs/theme#customizing-your-theme">theme documentation</Link>.
        </p>
      ) : (
        <p>
...
export function CustomizingYourSpacingScale({
  utility,
  utilities,
}: {
  utility: string;
  ...
  return (
    <>
      <p>
        ...
        utilities are driven by the <code>--spacing</code> theme variable, which can be customized
        in your own theme:
      </p>
      <div>
        <div className="not-prose">
      ...
      <p>
        Learn more about customizing the spacing scale in the{" "}
        <Link href="/docs/theme">theme variable documentation</Link>.
      </p>
    </>
  );
}
